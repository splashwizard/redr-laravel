    ...
    return (
        <>
            ...
            <section id="pricing" className="pricing section">
                ...
                <h2>Pricing for brands and businesses of all sizes</h2>
                <p>Connect to your audience with branded links, QR Codes, and landing pages that will get their attention.</p>
                </div>
                ...
                <div className="row gy-3">
                    ...
                    <div className="pricing-item">
                        ...
                        <ul>
                        <li><i className="material-icons-outlined">check_circle</i> <strong>2</strong> QR Redirect /m</li>
                        <li><i className="material-icons-outlined">check_circle</i> <strong>10</strong> URLs /m</li>
                        <li><i className="material-icons-outlined">check_circle</i> Detailed Statistics of link lifetime</li>
                        <li><i className="material-icons-outlined">check_circle</i> Unlimited Clicks and Scans</li>
                        <li className="na"><i className="material-icons-outlined">cancel</i> 1 Custom Landing Page</li>
                        <li className="na"><i className="material-icons-outlined">cancel</i> Bulk Management of URLs</li>
                        <li className="na"><i className="material-icons-outlined">cancel</i> Branded URL</li>
                        <li className="na"><i className="material-icons-outlined">cancel</i> Custom Webhooks</li>
                        </ul>
                    </div>
                    </div>

                    <div className="col-xl-4 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div className="pricing-item reco-tab">
                        ...
                        <ul>
                        <li><i className="material-icons-outlined">check_circle</i> <strong>5</strong> QR Redirect /m</li>
                        <li><i className="material-icons-outlined">check_circle</i> <strong>100</strong> URLs /m</li>
                        <li><i className="material-icons-outlined">check_circle</i> Detailed Statistics of link lifetime</li>
                        <li><i className="material-icons-outlined">check_circle</i> Unlimited Clicks and Scans</li>
                        <li><i className="material-icons-outlined">check_circle</i> 1 Custom Landing Page</li>
                        <li><i className="material-icons-outlined">check_circle</i> Bulk Management of URLs</li>
                        <li><i className="material-icons-outlined">check_circle</i> Branded URL</li>
                        <li className="na"><i className="material-icons-outlined">cancel</i> Custom Webhooks</li>
                        </ul>
                    </div>
                    </div>
                    ...
                    <div className="pricing-item">
                        ...
                        <ul>
                        <li><i className="material-icons-outlined">check_circle</i> <strong>10</strong> QR Redirect /m</li>
                        <li><i className="material-icons-outlined">check_circle</i> <strong>500</strong> URLs /m</li>
                        <li><i className="material-icons-outlined">check_circle</i> Detailed Statistics of link lifetime</li>
                        <li><i className="material-icons-outlined">check_circle</i> Unlimited Clicks and Scans</li>
                        <li><i className="material-icons-outlined">check_circle</i> <strong>5</strong> Custom Landing Page</li>
                        <li><i className="material-icons-outlined">check_circle</i> Bulk Management of URLs</li>
                        <li><i className="material-icons-outlined">check_circle</i> Branded URL</li>
                        <li><i className="material-icons-outlined">check_circle</i> Custom Webhooks</li>
                        </ul>
                    </div>
                    </div>
                </div>
